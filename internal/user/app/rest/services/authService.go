...
func NewUserService(repo contracts.IAuthRepository, outport ports.AuthOutputPort) *AuthService {
	return &AuthService{
		repo:    repo,
		outport: outport,
	}
...
func (obj *AuthService) Create(dto dtos.LoginDTO) shared_contracts.ViewModel {
