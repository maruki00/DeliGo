...
func NewProductRepository(db pkgPostgres.PGHandler) *ProductRepo {
	return &ProductRepo{
		db: db,
	}
}
...
// Commands
func (_this *ProductRepo) Save(ctx context.Context, product *model.Product) error {
...
func (_this *ProductRepo) Update(ctx context.Context, id sharedvo.ID, product *model.Product) error {
	return _this.db.GetDB().Transaction(func(tx *gorm.DB) error {
...
func (_this *ProductRepo) Delete(ctx context.Context, id sharedvo.ID) error {
	return _this.db.GetDB().Transaction(func(tx *gorm.DB) error {
...
// Queries
func (_this *ProductRepo) GetById(ctx context.Context, id sharedvo.ID) (*model.Product, error) {
...
func (_this *ProductRepo) Search(ctx context.Context, search string, pagination pagination.Pagination) ([]*model.Product, error) {
...
func (_this *ProductRepo) GetManyProductsByID(ctx context.Context, ids []sharedvo.ID) ([]*model.Product, error) {
	var items []*model.Product
